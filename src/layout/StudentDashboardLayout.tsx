import { Box, Button, Container, Flex, FormControl, FormLabel, Grid, Input, Link, ListItem, Text, UnorderedList } from "@chakra-ui/react";
		...
		<Box>
			<Container maxW={"container.xl"}>
				<Flex paddingY={"1rem"} justifyContent={"space-between"}>
					<Logo />
					<Flex display={{ base: "none", md: "flex" }} columnGap={8}></Flex>
				</Flex>
			</Container>
